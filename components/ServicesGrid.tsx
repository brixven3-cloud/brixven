        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-[#1a1a1a] border border-[#1a1a1a]">
          {SERVICES.map((service, i) => {
            ...
            return (
              ...
              >
                <div className="w-10 h-10 flex items-center justify-center mb-5 border border-[#222222] group-hover:border-[#C9A96E] transition-colors duration-300">
                  <Icon size={18} className="text-[#555555] group-hover:text-[#C9A96E] transition-colors duration-300" strokeWidth={1.5} />
                </div>
