      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-xl mb-16">
          <p className="text-[10px] font-semibold tracking-[0.22em] uppercase text-[#444444] mb-4 flex items-center gap-3">
            <span className="w-6 h-px bg-[#333333]" /> Our Team
          </p>
          <h2
          ...
          >
            ...
            <em style={{ fontStyle: 'italic' }}>Brixven</em>
          </h2>
            ...
            >
              <div className="relative h-56 bg-[#111111] flex items-center justify-center overflow-hidden">
                {member.photo ? (
                  ...
                  <div className="w-20 h-20 bg-white flex items-center justify-center text-black text-2xl font-bold">
                    {member.initials}
                  </div>
                )}
              ...
              <div className="p-6 border-t border-[#1a1a1a]">
                ...
                <p className="text-[#555555] text-xs font-semibold tracking-[0.15em] uppercase mb-3">{member.role}</p>
