...
function DashboardIllustration() {
  return (
    <div className="relative w-full max-w-md mx-auto lg:mx-0">
      <div className="absolute -inset-4 bg-emerald-500/[0.03] rounded-3xl" />
      <div className="relative bg-[#0d1521] border border-[#1e2d3d] shadow-[0_20px_60px_-10px_rgba(0,0,0,0.8)] overflow-hidden">
        <div className="px-5 py-4 border-b border-[#1e2d3d] flex items-center justify-between bg-[#080e18]">
        ...
        <div className="p-5 space-y-4">
          {[
            ...
            { label: 'SEO Campaign', pct: 65, color: '#6b7a8d' },
          ...
          <div className="pt-2 flex items-center justify-between border-t border-[#1e2d3d]">
            <div className="flex -space-x-2">
              {['#ffffff', '#888888', '#555555', '#34D399'].map((c, i) => (
                <div key={i} className="w-7 h-7 rounded-full border-2 border-[#0d1521] flex items-center justify-center text-[9px] font-bold text-black" style={{ background: c }}>
                  {['AK', 'RJ', 'MN', 'SB'][i]}
                </div>
              ))}
            </div>
        ...
        <div className="px-5 py-3 bg-[#080e18] border-t border-[#1e2d3d] flex items-center gap-2">
