      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-xl mb-16">
          <p className="text-[10px] font-semibold tracking-[0.22em] uppercase text-[#444444] mb-4 flex items-center gap-3">
            <span className="w-6 h-px bg-[#333333]" /> Our Work
          </p>
          <h2
          ...
          {PORTFOLIO.map((project, i) => (
            ...
            >
              <div className="relative h-44 flex items-center justify-center overflow-hidden bg-[#111111]">
                <div className="w-32 bg-[#1a1a1a] border border-[#2a2a2a] overflow-hidden shadow-md">
                  ...
                  <div className="p-2.5 space-y-1.5">
                    <div className="h-1.5 rounded-sm bg-white/20" style={{ width: '80%' }} />
              ...
              <div className="p-6 border-t border-[#1a1a1a]">
                <span className="text-[10px] font-semibold tracking-[0.15em] uppercase mb-3 block text-[#555555]">
                  {project.category}
                </span>
